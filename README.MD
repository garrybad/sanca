...
graph TB
    ...
    subgraph "⛓️ Blockchain - Mantle Network"
        direction TB
...
- **DEX**: Agni Router (USDC ↔ USDY swaps, mainnet)
...
3. Approve USDC for collateral (contribution × maxMembers)
4. Join the pool
